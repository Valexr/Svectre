<h4 class="s-subtitle" id="typography-semantic-text">
    Semantic text elements
    <a class="anchor" href="#typography-semantic-text" aria-hidden="true">#</a>
</h4>
<div class="columns">
    <div class="column col-6 col-xs-12">
        <abbr title="Internationalization">I18N</abbr><code class="ml-2"
            >abbr</code
        >
    </div>
    <div class="column col-6 col-xs-12">
        <strong>Bold</strong><code class="ml-2">strong</code><code class="ml-2"
            >b</code
        >
    </div>
    <div class="column col-6 col-xs-12">
